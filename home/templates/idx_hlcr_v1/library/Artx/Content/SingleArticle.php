...
class ArtxContentSingleArticle extends ArtxContentItem
{
    ...
    public function printIcon()
    {
        ...
        $text = str_replace('<i class="icon-print', '<i class="idx-postprinticon', $text);
        return $text;
    }

    public function toc($toc)
    {
        return '<div class="idx-article">' . $toc . '</div>';
    }

    public function intro($intro)
    {
        return '<div class="idx-article">' . $intro . '</div>';
    }

    public function text($text)
    {
        return '<div class="idx-article">' . $text . '</div>';
    }
