...
{
  $style = isset($attribs['artstyle']) ? $attribs['artstyle'] : 'idx-nostyle';
  $styles = array(
    'idx-nostyle' => 'modChrome_artnostyle',
    'idx-block' => 'modChrome_artblock',
    'idx-article' => 'modChrome_artarticle',
    'idx-vmenu' => 'modChrome_artvmenu'
  );
  ...
  //  'idx-...'        - overwrites the default module style.
  //  'suffix idx-...' - overwrites the default style and adds suffix to the module and
  //                     to its elements, does not add idx-... to the module elements.
...
<!-- begin nostyle -->
<div class="idx-nostyle<?php echo $params->get('moduleclass_sfx'); ?>">
